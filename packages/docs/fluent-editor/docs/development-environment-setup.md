...
![](../public/images/开发环境配置-monorepo架构.png)

## 快速设置流程

设置过程可以可视化为一个简化的工作流：

![](../public/images/快速设置流程.png)
...
- 探索[核心架构和设计原则](./core-architecture-and-design-principles.md)以了解编辑器的内部结构
- 学习[理解 FluentEditor 类结构](./understanding-tiny-editor-class-structure.md)获取详细的 API 知识
- 查看[基本用法示例](./basic-usage-examples.md)了解编辑器的实际运行效果
